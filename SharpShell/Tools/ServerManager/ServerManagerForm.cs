...
namespace ServerManager
{
    ...
    public partial class ServerManagerForm : Form
    {
        ...
        private void installServerx86ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            ServerRegistrationManager.InstallServer(SelectedServerEntry.Server, RegistrationType.OS32Bit, RegistrationLocation.LocalMachine, true);
        ...
        private void uninstallServerx86ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            ServerRegistrationManager.UninstallServer(SelectedServerEntry.Server, RegistrationType.OS32Bit, RegistrationLocation.LocalMachine);
            serverDetailsView1.Initialise(SelectedServerEntry);
        }
        ...
        private void installServerx64ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            ServerRegistrationManager.InstallServer(SelectedServerEntry.Server, RegistrationType.OS64Bit, RegistrationLocation.LocalMachine, true);
            serverDetailsView1.Initialise(SelectedServerEntry);
        }
        ...
        private void uninstallServerx64ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            ServerRegistrationManager.UninstallServer(SelectedServerEntry.Server, RegistrationType.OS64Bit, RegistrationLocation.LocalMachine);
            serverDetailsView1.Initialise(SelectedServerEntry);
        }
        ...
        private void registerServerx86ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            ServerRegistrationManager.RegisterServer(SelectedServerEntry.Server, RegistrationType.OS32Bit, RegistrationLocation.LocalMachine);
            serverDetailsView1.Initialise(SelectedServerEntry);
        ...
        private void registerServerx64ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            ServerRegistrationManager.RegisterServer(SelectedServerEntry.Server, RegistrationType.OS64Bit, RegistrationLocation.LocalMachine);
            serverDetailsView1.Initialise(SelectedServerEntry);
            CheckIfRegisterOrUnregisterRequiresExplorerRestart(SelectedServerEntry.Server);
        }
        ...
        private void unregisterServerx86ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            ServerRegistrationManager.UnregisterServer(SelectedServerEntry.Server, RegistrationType.OS32Bit, RegistrationLocation.LocalMachine);
            serverDetailsView1.Initialise(SelectedServerEntry);
            CheckIfRegisterOrUnregisterRequiresExplorerRestart(SelectedServerEntry.Server);
        }
        ...
        private void unregisterServerx64ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            ServerRegistrationManager.UnregisterServer(SelectedServerEntry.Server, RegistrationType.OS64Bit, RegistrationLocation.LocalMachine);
            serverDetailsView1.Initialise(SelectedServerEntry);
            CheckIfRegisterOrUnregisterRequiresExplorerRestart(SelectedServerEntry.Server);
        }
